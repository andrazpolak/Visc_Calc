...
'''
This little web application uses a artificial neural network (ANN) to calculate viscosities of silicate melts. To your left you see a tab where the appropriate oxide
